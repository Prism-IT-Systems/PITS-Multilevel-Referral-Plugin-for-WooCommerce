...
jQuery( document ).ready(
	function () {
		...
		jQuery( '#widraw_filter_id #reset_widthraw' ).click(
			function () {
		...
		jQuery( 'input[name="paytm_id"]' ).keypress(
			function (e) {
		...
		jQuery( 'input[name="paytm_amount"]' ).keypress(
			function (e) {
		...
		jQuery( '#reg_billing_phone' ).keypress(
			function (e) {
		...
		jQuery( 'input[name="paytm_amount"]' ).keyup(
			function () {
...
jQuery( document ).ready(
	function () {
		jQuery( '.saved_bank_details_info .remove_bank_info' ).click(
			function (e) {
				e.preventDefault();
