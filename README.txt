...
Tags: woocommerce, referral, credit points, commission, invite friends 
...
[woocommerce_multilevel_referral_invite_friends] =  this shortcode will show invite friend form.

[woocommerce_multilevel_referral_show_credit_info] = this will show logged in user credit point information.
...
== Installation ==
1. Upload the 'Multilevel Referral Plugin for WooCommerce' plugin to the "/wp-content/plugins/" directory.
1. Activate the plugin through the "Plugins" menu in WordPress.

== Changelog ==

= 2.28.1 =
* Fix - fixed issue with date validation and security issue.
